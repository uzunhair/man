        ...
        var make = function() {
            ...
            $(this).submit(function() {
                ...
                function errorRes(errorMessage) {
                    btn.removeClass('progress-bar-animated progress-bar-striped bg-primary');
                ...
                $.ajax({
                    ...
                    data: data,
                    beforeSend: function() {
                        btn.addClass('progress-bar-animated progress-bar-striped bg-primary');
                    },
                    success: function(res) {
                        if (res == 1) {
                            ...
                            $('html, body').animate({ scrollTop: $this }, "slow");
